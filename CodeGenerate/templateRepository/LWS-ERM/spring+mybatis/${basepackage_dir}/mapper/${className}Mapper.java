...
public interface ${className}Mapper {
	...
	public List<${className}> findAll(@Param("record")${className} record, @Param("rowBounds")RowBounds rowBounds);
	
	public Long getCount(@Param("record")${className} record);

	public List<${className}> findPage(@Param("record")${className} record, @Param("rowBounds")RowBounds rowBounds);
