...
public class ${className}ServiceImpl implements ${className}Service {
    ...
    public List<${className}> findAll(${className} record,RowBounds rowBound) {
        return this.${classNameFirstLower}Mapper.findPage(record, rowBound,null);
    }
    ...
    public Map<String, ?> findPage(${className} record, Integer start, Integer limit) {
        ...
        List<${className}> list = this.${classNameFirstLower}Mapper.findPage(record, new RowBounds(start, limit),null);
        map.put(Constants.lab_data, list);
