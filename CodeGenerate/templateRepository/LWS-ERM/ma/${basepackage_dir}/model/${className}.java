...
<#macro generateJavaColumns>
	...
	static{
		...
		_map.put(com.dgtech.base.mybatis.TableMap.mark_tableName, "${table.sqlName}");
		_map.put(com.dgtech.base.mybatis.TableMap.mark_idColum, "${table.idColumn.sqlName}");
		<#list table.columns as column>
		_map.put("${column.columnNameLower}","${column.sqlName}");
		</#list>
		
		com.dgtech.base.mybatis.TableMap.regist(${className}.class.getSimpleName(), _map);
	}
